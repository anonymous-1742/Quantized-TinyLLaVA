...
class TinyLlavaConfig(PretrainedConfig):
    ...
    def load_from_config(self, config):
        ...
        self.vq_type=getattr(config, 'vq_type',  None)
        ...
        self.client_layer_num=getattr(config, 'client_layer_num',  None)
        self.discrete_size=getattr(config, 'discrete_size',  None)
        self._load_text_config()
        self._load_vision_config()
        #self.vq_config=VQ_config(embed_dim=self.hidden_size,discrete_size=self.vocab_size//50)
