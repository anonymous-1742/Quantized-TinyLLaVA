...
DATE="${12}"
#
#deepspeed --include localhost:0 --master_port 29504 tinyllava/train/tinyllava_server.py \
...
python tinyllava/train/tinyllava_server.py \
    ...
    --output_dir /nfs/turbo/umms-drjieliu1/usr/gjiajun/pretrain_server/tiny-llava-${LLM_VARIANT}-${VT_VARIANT}-${VERSION}-server-pretrain-${VQ_VERSION}-size-${VQ_SIZE}-${DATE} \
    --num_train_epochs 1 \
