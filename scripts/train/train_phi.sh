DATA_PATH=/scratch/drjieliu_root/drjieliu/gjiajun/TinyLLaVA_Factory/dataset/text_files/blip_laion_cc_sbu_558k.json #pretrain annotation file path
FINETUNE_DATA_PATH=/scratch/drjieliu_root/drjieliu/gjiajun/TinyLLaVA_Factory/dataset/text_files/llava_v1_5_mix665k.json #finetune annotation file path
IMAGE_PATH=/scratch/drjieliu_root/drjieliu/gjiajun/TinyLLaVA_Factory/dataset/llava/llava_pretrain/images #pretrain image dir
FINETUNE_IMAGE_PATH=/scratch/drjieliu_root/drjieliu/gjiajun/TinyLLaVA_Factory/dataset #finetune image dir
